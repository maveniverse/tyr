...
public class TyrArtifactFactory implements ProjectArtifactFactory {

    @Named
    public static class Module extends AbstractModule {
        @Override
        protected void configure() {
            bind(ProjectArtifactFactory.class).to(TyrArtifactFactory.class);
        }
    }
    ...
    public Set<Artifact> createArtifacts(MavenProject project) throws InvalidDependencyVersionException {
        ...
        DependencyVersionProvider context = new DependencyVersionProvider(targetPlatform, reactorProjects, strict);
        ...
        for (Dependency dependency : project.getDependencies()) {
            ...
            try {
                ...
                throw new InvalidDependencyVersionException(project.getId(), dependency, project.getFile(), e);
            }
